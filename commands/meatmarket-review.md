...
allowed-tools: ["mcp__meatmarket__submit_review", "mcp__meatmarket__inspect_state"]
---

Help the user leave a performance review for a human worker.

1. If job ID and worker ID aren't provided, call `inspect_state` to find completed jobs.
2. Ask the user for:
   - **Rating**: 1 to 5 stars
