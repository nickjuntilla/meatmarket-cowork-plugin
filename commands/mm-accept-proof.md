...
Manually review and pay for a completed job. Use this when you want to handle a specific proof yourself rather than using `/mm-check` for the automated evaluation pipeline.
...
6. Suggest leaving a review for the worker using `/mm-review`.
