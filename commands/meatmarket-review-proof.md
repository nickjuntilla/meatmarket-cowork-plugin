...
allowed-tools: ["mcp__meatmarket__get_proofs", "mcp__meatmarket__inspect_state", "mcp__meatmarket__request_revision", "mcp__meatmarket__mark_payment_sent"]
---

Help the user review proof of work submitted by a human worker.

1. If no job ID was provided, call `inspect_state` to find jobs with submitted proofs.
