...
2. Gather offer details (ask for anything not provided):
   ...
   - **Blockchain**: Payment chain (Base, Ethereum, Optimism, Arbitrum, or Polygon)
...
5. Let the user know the offer has been sent and the worker will be notified. They can cancel with `/meatmarket-cancel-offer` if needed.
